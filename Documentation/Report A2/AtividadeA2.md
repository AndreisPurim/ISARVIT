...
- **Login:**
	- Link da [Issue #17](https://github.com/AndreisPurim/ISARVIT/issues/28) e [Pull Request #28](https://github.com/AndreisPurim/ISARVIT/pull/27)
	-  Componente no [Frontend](https://github.com/AndreisPurim/ISARVIT/blob/main/Frontend/src/Pages/Login/LoginCard.tsx)
- **Signup:**
	- Link da [Issue #27](https://github.com/AndreisPurim/ISARVIT/issues/27) e [Pull Request #30](https://github.com/AndreisPurim/ISARVIT/pull/31)
	-  Componente no [Frontend](https://github.com/AndreisPurim/ISARVIT/blob/main/Frontend/src/Pages/Login/SignupCard.tsx)
...
O frontend já possui um deploy automático na branch ```gh-deploy``` que utiliza o Github Pages e permite acessar pelo link http://andreis.lv/ISARVIT/ (igualmente válido: https://AndreisPurim.github.io/ISARVIT). Portanto, não é necessário executar nada.
...
![CI/CD](https://github.com/AndreisPurim/ISARVIT/workflows/CI/CD/badge.svg) [![codecov](https://codecov.io/gh/AndreisPurim/ISARVIT/branch/main/graph/badge.svg)](https://codecov.io/gh/AndreisPurim/ISARVIT/branch/main)
...
- Github action CI/CD [Frontend](https://github.com/AndreisPurim/ISARVIT/blob/main/.github/workflows/cicd.yml) 
	- [Runs executadas](https://github.com/AndreisPurim/ISARVIT/actions/workflows/cicd.yml) com esse CI/CD
- Github action CI/CD [Backend](https://github.com/AndreisPurim/ISARVIT/blob/main/.github/workflows/backend_cicd.yml)
	- [Runs executadas](https://github.com/AndreisPurim/ISARVIT/actions/workflows/backend_cicd.yml) com esse CI/CD

O relatório de testes está disponível em cada run, e também disponível no site do Codecov ([Link](https://app.codecov.io/gh/AndreisPurim/ISARVIT)).
...
- Nós usamos [Milestones](https://github.com/AndreisPurim/ISARVIT/milestones) e [Projects](https://github.com/users/AndreisPurim/projects/1), apesar de que não com muito sucesso
